    ...
    <div class="popup-mobile-menu">
        <div class="inner">
            <div class="header-top">
                <div class="logo">
                    <router-link to="/">
                        <img class="logo-light" src="../../../assets/images/logo/mini-logo.png" alt="Corporate Logo">
                        <img class="logo-dark" src="../../../assets/images/logo/mini-logo.png" alt="Corporate Logo">
                    </router-link>
                </div>
